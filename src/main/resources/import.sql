...
-- Agendamentos (OK)
INSERT INTO tb_agendamento(funcionario_id, cliente_id, procedimento_id, data, situacao, numero_parcelas, valor_total) VALUES (1, 2, 1, '2025-07-04', 'PENDENTE', 1, 40), (1, 3, 2, '2025-07-04', 'CONFIRMADO', 2, 70), (2, 1, 3, '2025-07-05', 'CANCELADO', 1, 25);
...
-- Usuários (OK)
INSERT INTO tb_usuario(login, senha, nivel_acesso, pessoa_id) VALUES ('AAA', '$2a$10$ZQDZDXqV/LKQTq13NKJ2aeUmrxV787/U1BSEfXS.pGPu0Sd9CgYX6', 'FUNCIONARIO', 1), ('BBB', '$2a$10$ZQDZDXqV/LKQTq13NKJ2aeUmrxV787/U1BSEfXS.pGPu0Sd9CgYX6', 'CLIENTE', 2), ('CCC', '$2a$10$ZQDZDXqV/LKQTq13NKJ2aeUmrxV787/U1BSEfXS.pGPu0Sd9CgYX6', 'FUNCIONARIO', 3);